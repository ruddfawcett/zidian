<?php
  /**
   * Would love to credit this, but I can't remember where I got it.
   * I think it is from a tutorial on how to use the Quizlet API.
   * I only used it to generate an OAuth token which I used in upload.php
   */

  // Your credentials
  $myClientId = '';
  $mySecret = '';
  $myUrl = 'http://localhost:8080/import.php';
